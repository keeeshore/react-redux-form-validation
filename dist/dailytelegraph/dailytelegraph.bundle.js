...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return FormDataContext; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return FormInput; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return InputComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return LeftComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return InputComponentStyles; });
// const masthead = document.location.pathname.split('/')[2];
var Module = __webpack_require__(40); // TEST LOG FOR DEBUGGING START --------------


Object.keys(Module).forEach(function (k) {
  return console.log(":::::::::::: ".concat("dailytelegraph", " has custom Module.").concat(k, "::::::::::::::::::"));
}); // TEST LOG FOR DEBUGGING END ----------------

var _require = __webpack_require__(24),
    FormComponent = _require.FormComponent,
    FormDataContext = _require.FormDataContext;



var _require2 = __webpack_require__(31),
    FormInput = _require2.FormInput;



var _ref = Module.InputComponent ? Module : __webpack_require__(32),
    InputComponent = _ref.InputComponent;



var _ref2 = Module.LeftComponent ? Module : __webpack_require__(14),
    LeftComponent = _ref2.LeftComponent;


var InputComponentStyles = Module.InputComponentStyles || __webpack_require__(33);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getDynamicContent; });
/* harmony import */ var _config_default_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
var _config_default_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(9, 1);
/* harmony import */ var _common_content_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
var _common_content_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(8, 1);
...
var config = function () {
  var stage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "prod";
  var masthead = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "dailytelegraph";
  return _objectSpread({}, _config_default_json__WEBPACK_IMPORTED_MODULE_0__, {}, __webpack_require__(20)("./".concat(stage, ".json")), {
    content: _objectSpread({}, _common_content_json__WEBPACK_IMPORTED_MODULE_1__, {}, __webpack_require__(22)("./".concat(masthead, "/content.json")))
  });
}("prod", "dailytelegraph");

var getDynamicContent = function getDynamicContent() {
...
__webpack_require__.d(__webpack_exports__, "d", function() { return /* reexport */ useStore_useStore; });

// UNUSED EXPORTS: connectAdvanced, ReactReduxContext, connect, batch, createDispatchHook, createSelectorHook, createStoreHook, shallowEqual
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AppDataContext; });
...
var defaultCustomerState = {
  // email: `kishore.balan+${new Date().toUTCString().substr(5, 20).replace(/[ ,:-]/g, '.')}@news.com.au`,
  // password: 'UGFzc3dvcmQxMjM=',
  firstName: 'Test',
  lastName: 'B'
};
var defaultOfferSetState = {
  test: 'ooooooooooo',
  pkgDef: '111'
};

var offerset = function offerset() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultOfferSetState;
...
var customer = function customer() {
  ...
  switch (action.type) {
    case 'CUSTOMER':
      {
        newState = _objectSpread({}, state, {}, action.payload);
        break;
      }
...
var rootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_1__[/* combineReducers */ "b"])({
  customer: customer,
  offerset: offerset
});
...
module.exports = JSON.parse("{\"ENV\":\"local\",\"X_API_KEY\":\"YoirhjBBxV3up3DKko0yM8mXQ0Nnl6af8Cd7kPhy\",\"COMMERCE_API\":\"https://sit.commerceapi.news.com.au\",\"id\":\"This is default id\",\"title\":\"I am default version _DEFAULT_\"}");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _content_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
var _content_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(8, 1);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);




function LeftComponent(_ref) {
  ...
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "left component : common ", counter, " "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* getDynamicContent */ "b"])(_content_json__WEBPACK_IMPORTED_MODULE_1__.intro_1, count), ", counter = ", counter));
}
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(13),r=__webpack_require__(18);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
module.exports = JSON.parse("{\"title\":\"I am version for _PROD_\",\"id\":\"prod prod\"}");
...
var map = {
	"./dailytelegraph/content.json": 23
};
...
module.exports = JSON.parse("{\"url\":\"https://localhost/default _DT_\"}");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormDataContext", function() { return FormDataContext; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony import */ var _Redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
...
var FormDataContext = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext();

function FormComponent(props) {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])([]),
      _useState2 = _slicedToArray(_useState, 2),
      validators = _useState2[0],
      setValidators = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])('ready...'),
  ...
  var onInputElemAdded = function onInputElemAdded(elemRef) {
    ...
    setValidators(function (validators) {
      return validators.concat(elemRef);
    });
  };
  ...
  var onFormSubmit = function onFormSubmit(event) {
    ...
    Promise.all(validators.map(function (elemRef) {
      ...
      console.log("FormComponent :: onFormSubmit has ".concat(errors.length, " errors = "), errors);
      props.onSubmit();
...
/* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
...
var FormInput = function FormInput(props) {
  ...
  var childRef = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])();
  var formDataContext = Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(_modules__WEBPACK_IMPORTED_MODULE_2__[/* FormDataContext */ "b"]);
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    console.log("FormInput :: useEffect componentDidMount for ".concat(props.id));
    formDataContext.onInputElemAdded(childRef);
  }, []);
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_modules__WEBPACK_IMPORTED_MODULE_2__[/* InputComponent */ "d"], _extends({
    ref: childRef
  }, props));
};
...
/* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1);
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }
...
var Input = Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function (props, ref) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(inputStates.PRISTINE),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(false),
      _useState6 = _slicedToArray(_useState5, 2),
      loaderClass = _useState6[0],
      setLoaderClass = _useState6[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useImperativeHandle"])(ref, function () {
    return {
      isValid: function isValid() {
        var error;
        return regenerator_runtime__WEBPACK_IMPORTED_MODULE_0___default.a.async(function isValid$(_context) {
          while (1) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    function anyNameFunction() {
      return regenerator_runtime__WEBPACK_IMPORTED_MODULE_0___default.a.async(function anyNameFunction$(_context2) {
        while (1) {
  ...
  var validate = function validate(args) {
    var error;
    return regenerator_runtime__WEBPACK_IMPORTED_MODULE_0___default.a.async(function validate$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            error = "".concat(props.label, " is required");
  ...
  var TextInput = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "".concat(_modules__WEBPACK_IMPORTED_MODULE_3__[/* InputComponentStyles */ "e"].InputComponent)
  }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "form-group ".concat(inputState, " ").concat(loaderClass)
  }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("label", {
    for: props.id
  }, props.label), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
    type: props.type,
    id: props.id,
    value: value,
    className: "form-control is-".concat(error ? formStates.INVALID : formStates.VALID),
    onFocus: handleInputChange,
    onChange: handleInputChange,
    onBlur: handleInputChange
  }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "".concat(error ? formStates.INVALID : formStates.VALID, "-feedback")
  }, error)));
  return TextInput;
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/svg+xml;base64,");
...
// EXTERNAL MODULE: ./src/common/modules.js
...
function AppComponent(props) {
  ...
  return react_default.a.createElement("div", {
    className: "container"
  }, react_default.a.createElement(modules["a" /* FormComponent */], _extends({
    onSubmit: appFormSubmit
  ...
  }, "Validate and Submit")))), react_default.a.createElement(modules["f" /* LeftComponent */], {
    count: props.data.count,
    counter: counter
  }), react_default.a.createElement("p", {
    class: "lead"
  }, " counter = ", counter, " , ", "dailytelegraph", ", ", utils["a" /* config */].id, ", ", utils["a" /* config */].title));
}
...
function register(config) {
  if ( true && 'serviceWorker' in navigator) {
    ...
    var publicUrl = new URL({}.PUBLIC_URL, window.location.href);
    ...
    window.addEventListener('load', function () {
      var swUrl = "".concat({}.PUBLIC_URL, "/service-worker.js");
...
// EXTERNAL MODULE: ./src/common/Redux/index.js
var Redux = __webpack_require__(5);

// CONCATENATED MODULE: ./src/mastheads/dailytelegraph/index.js
...
react_dom_default.a.render(react_default.a.createElement(react_default.a.StrictMode, null, react_default.a.createElement(es["a" /* Provider */], {
  store: Redux["c" /* store */]
}, react_default.a.createElement(Redux["a" /* AppDataContext */].Provider, {
  value: Redux["b" /* data */]
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "LeftComponent", function() { return /* reexport */ LeftComponent; });
...
// CONCATENATED MODULE: ./src/mastheads/dailytelegraph/LeftComponent/index.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }
...
// CONCATENATED MODULE: ./src/mastheads/dailytelegraph/modules.js
